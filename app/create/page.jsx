...
import BulkUpload from '@/components/aireel';
...
/>
            ...
            {selectedOption === 'bulk' && (
              <div className="bg-gray-900/60 backdrop-blur-sm rounded-2xl border border-gray-800 p-8 transition-all animate-fadeIn relative overflow-hidden">
                ...
                <div className="text-center mb-6 relative z-10">
                  <h2 className="text-2xl font-semibold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-blue-300">AI Generated Reel</h2>
